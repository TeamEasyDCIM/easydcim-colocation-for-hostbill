...
$lang['serverAA']['productConfig']['mainContainer']['configForm']['defaultOptions']['igRow']['ModelID']['ModelID'] ='Colocation Model';
$lang['serverAA']['productConfig']['mainContainer']['configForm']['defaultOptions']['igRow']['ModelID']['description'] = 'Colocation model used as a base for the product. Server will be assigned to an order when it matches.';
...
$lang['serverAA']['productConfig']['mainContainer']['configForm']['clientAreaFeaturesSection']['leftSection']['serviceInfo']['Model']['Model'] = 'Model';
$lang['serverAA']['productConfig']['mainContainer']['configForm']['clientAreaFeaturesSection']['leftSection']['serviceInfo']['Location']['Location'] = 'Location';
...
$lang['serverAA']['productConfig']['mainContainer']['configForm']['clientAreaFeaturesSection']['rightSection']['graphTypes']['PowerUsageStatisticsGraph']['PowerUsageStatisticsGraph'] = 'Power Usage';
...
$lang['serverCA']['home']['mainContainer']['statusWidget']['logIntoPanel']['logIntoPanel'] = 'Log In To Panel';
...
$lang['serverAA']['servicePageIntegration']['mainContainer']['powerUsageStatisticsTable']['powerUsageStatisticsTable'] = 'Power Usage Statistics';
$lang['serverAA']['servicePageIntegration']['mainContainer']['powerUsageStatisticsTable']['table']['powerUsageInterval']     = 'Interval';
$lang['serverAA']['servicePageIntegration']['mainContainer']['powerUsageStatisticsTable']['table']['AVG_TOTAL_USAGE']     = 'Power Usage (Amps)';
...
$lang['serverAA']['servicePageIntegration']['mainContainer']['powerUsageGraph']['title'] = 'Power Usage';
...
$lang['serverCA']['devicesTraffic']['mainContainer']['networkPortsTable']['networkPortsTable'] = 'Network Ports';
$lang['serverCA']['devicesTraffic']['mainContainer']['networkPortsTable']['table']['label'] = 'Label';
$lang['serverCA']['devicesTraffic']['mainContainer']['networkPortsTable']['table']['device'] = 'Device';
$lang['serverCA']['devicesTraffic']['mainContainer']['networkPortsTable']['table']['last_hour_traffic'] = 'Last Hour Traffic';
$lang['serverCA']['devicesTraffic']['mainContainer']['networkPortsTable']['table']['last_day_traffic'] = 'Last Day Traffic';
$lang['serverCA']['devicesTraffic']['mainContainer']['networkPortsTable']['table']['last_month_traffic'] = 'Last Month Traffic';
...
$lang['serverAA']['servicePageIntegration']['mainContainer']['details']['tableField']['label'] = 'Label';

$lang['serverAA']['servicePageIntegration']['mainContainer']['networkPorts']['networkPorts'] = 'Network Ports';
$lang['serverAA']['servicePageIntegration']['mainContainer']['networkPorts']['tableField']['label'] = 'Label';
$lang['serverAA']['servicePageIntegration']['mainContainer']['networkPorts']['tableField']['device'] = 'Device';
$lang['serverAA']['servicePageIntegration']['mainContainer']['networkPorts']['tableField']['last_hour_traffic'] = 'Last Hour Traffic';
$lang['serverAA']['servicePageIntegration']['mainContainer']['networkPorts']['tableField']['last_day_traffic'] = 'Last Day Traffic';
$lang['serverAA']['servicePageIntegration']['mainContainer']['networkPorts']['tableField']['last_month_traffic'] = 'Last Month Traffic';

$lang['serverAA']['servicePageIntegration']['mainContainer']['powerOutlets']['powerOutlets'] = 'Power Outlets';
$lang['serverAA']['servicePageIntegration']['mainContainer']['powerOutlets']['tableField']['status'] = 'Status';
$lang['serverAA']['servicePageIntegration']['mainContainer']['powerOutlets']['tableField']['number'] = 'Number';
$lang['serverAA']['servicePageIntegration']['mainContainer']['powerOutlets']['tableField']['label'] = 'Label';
$lang['serverAA']['servicePageIntegration']['mainContainer']['powerOutlets']['tableField']['state'] = 'State';
$lang['serverAA']['servicePageIntegration']['mainContainer']['powerOutlets']['tableField']['device'] = 'Device';
